...
describe("parse", () => {
  ...
  describe("single binary operators", () => {
    it("dot", () => {
      expect(parse("a.b")).toEqual(binary(Operator.DOT, leaf("a"), leaf("b")));
    });
    ...
    it("lt", () => {
      expect(parse("a < b")).toEqual(binary(Operator.LT, leaf("a"), leaf("b")));
    });
    ...
    it("gt", () => {
      expect(parse("a > b")).toEqual(binary(Operator.GT, leaf("a"), leaf("b")));
    });
    ...
    it("eq", () => {
      expect(parse("a = b")).toEqual(binary(Operator.EQ, leaf("a"), leaf("b")));
    });
